...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('profile_completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('team', self.gf('django.db.models.fields.related.OneToOneField')(related_name='team', unique=True, null=True, to=orm['teams.Team'])),
        ))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'team': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'team'", 'unique': 'True', 'null': 'True', 'to': u"orm['teams.Team']"}),
