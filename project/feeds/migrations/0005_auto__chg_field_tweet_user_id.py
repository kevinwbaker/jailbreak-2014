...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.user_id'
        db.alter_column(u'feeds_tweet', 'user_id', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Tweet.user_id'
        db.alter_column(u'feeds_tweet', 'user_id', self.gf('django.db.models.fields.PositiveIntegerField')())
